...
export const projects = [
  {
    ...
    desc: 'Sistema completo de controle financeiro para PMEs com dashboards, relatórios e alertas automáticos.',
  ...
  },
  {
    emoji: '🚚',
    tag: 'Logística',
    title: 'App de Rastreamento de Frotas',
    desc: 'Aplicativo mobile para gestão de frotas com GPS em tempo real, alertas e histórico de rotas.',
    techs: ['React Native', 'AWS', 'WebSocket'],
    gradient: 'linear-gradient(135deg, #0d2a1a, #0a1a40)',
  },
  {
    emoji: '🛍️',
    tag: 'E-commerce',
    title: 'Marketplace Multi-vendedor',
    desc: 'Plataforma de venda online com painel do vendedor, checkout otimizado e integração logística.',
    techs: ['Next.js', 'Stripe', 'Redis'],
  ...
  },
  {
    ...
    desc: 'Assistente virtual com LLM para atendimento 24/7, integrado ao WhatsApp e CRM da empresa.',
    techs: ['Python', 'OpenAI', 'WhatsApp API'],
    gradient: 'linear-gradient(135deg, #1a1a0a, #0a1a30)',
  },
  {
    emoji: '🏥',
    tag: 'Saúde',
    title: 'Sistema de Agendamento Médico',
    desc: 'Plataforma de agendamento online para clínicas com prontuário eletrônico e teleconsulta.',
    techs: ['Vue.js', 'Laravel', 'MySQL'],
    gradient: 'linear-gradient(135deg, #0a2a2a, #0a0a40)',
  },
  {
    emoji: '⚙️',
    tag: 'Automação',
    title: 'Automação de Processos RH',
    desc: 'Sistema de onboarding digital, controle de ponto e folha de pagamento automatizada para PMEs.',
    techs: ['React', 'n8n', 'Supabase'],
    gradient: 'linear-gradient(135deg, #2a1a0a, #1a0a3a)',
  },
];
